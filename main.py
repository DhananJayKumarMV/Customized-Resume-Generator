...
st.set_page_config(
    ...
    page_icon=r"c:\Users\mvdk1\Downloads\resumate_ai3.png",
    layout="centered",
...
st.markdown("<div class='title'>Resumate.ai</div>", unsafe_allow_html=True)
...
# ----------------------- App Inputs -----------------------
groq_api_key = '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'
